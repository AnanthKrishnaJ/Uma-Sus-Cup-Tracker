...
new_gallery = '`<img src="${image}" alt="Sus Cup ${race.cupNumber} result screenshot ${index + 1}" loading="lazy" style="cursor:pointer;" onclick="openGalleryModal([${race.images.map(img => `\\'${img}\\'`).join(\',\')}], ${index})">`'
